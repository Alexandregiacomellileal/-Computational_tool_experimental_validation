...
- **$θmed_{FoP}^{HF}$ (°):** The delay angle between the voltage wave ($V_p$) and current wave ($I_c$), calculated as $(\frac{t_d \cdot 360}{T})$, represents the time delay in the waveform with a period of T.
