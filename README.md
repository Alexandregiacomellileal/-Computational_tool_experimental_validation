...
## Overview
This repository provides detailed information on the experimental validation conducted for the *computational tool* proposed in the associated research paper. The objective of this *computational tool* is to accurately estimate the individual grounding resistance of wind turbines when interconnected with the wind farm's grounding system through horizontal electrodes. It serves as an ally in identifying processes of performance deterioration in the individual grounding system of the turbine throughout the lifespan of the wind farm.
